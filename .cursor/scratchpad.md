...
- PosterView now preserves paragraph and line breaks in the description, so pasted formatted text should display as intended. Please review and confirm if this resolves the formatting issue.
...
- Awaiting user review of description formatting in PosterView.
